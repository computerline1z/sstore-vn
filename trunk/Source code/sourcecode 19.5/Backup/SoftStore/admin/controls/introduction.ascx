...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="introduction.ascx.cs" Inherits="SoftStore.admin.controls.introduction" %>
            ...
            <asp:repeater id="rptList" runat="Server" >
                <itemtemplate>
                    <tr>
                        ...
                        <td><a href="default.aspx?n=introduction&id=<%# Eval("ID") %>" ><%# Eval("Title")%> </a></td>
