<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="edit_profile.ascx.cs" Inherits="SoftStore.controls.edit_profile" %>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 50%">
                                <asp:Label ID="txtUserName" runat="server" CssClass="txt" Font-Bold="true"></asp:Label></td>
                        ...
                        <tr>
                            <td align="right" style="width: 20%">
                                Mật khẩu:&nbsp;</td>
                            <td align="left" style="width: 50%">
                            <a class="link" href="/doi-mat-khau.html"><b>Đổi mật khẩu</b></a>
                                </td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 20%">
                    ...
                    <input id="flAvatar" runat="server" name="flAvatar" onchange="setImg(this.value);" style="width: 300px; height: 22px;" type="file" class="txt" />
                        ...
                        <tr>
                            <td style="width: 20%">
                                &nbsp;</td>
                            <td align="left" style="width: 50%">
                                <asp:Button ID="btnRegister" OnClientClick="return checkNull()" CssClass="small-button" runat="server" Text="Cập nhật"
