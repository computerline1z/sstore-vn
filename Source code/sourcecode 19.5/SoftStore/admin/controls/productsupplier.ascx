<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="productsupplier.ascx.cs" Inherits="SoftStore.admin.controls.productsupplier" %>
    ...
    <tr>
            ...
            <asp:repeater id="rptList" runat="Server" >
                <itemtemplate>
                    <tr>
                        ...
                        <td><a href="default.aspx?n=productsupplier&id=<%# Eval("SupplierID") %>" ><%# Eval("SupplierName")%> </a></td>
                        ...
                        <td align="center"><input type="checkbox" name="select" id="select" value='<%# Eval("SupplierID")%>' /> </td>
                    </tr>
                </itemtemplate>
            </asp:repeater>
            </tbody>  
        ...
        <tr>
            <td align="center">
                ...
                <asp:ImageButton OnClientClick="return confirm('Xác nhận xóa nhà cung cấp đã chọn')" ID="btnDel" runat="server" BorderWidth="1px" ImageUrl="../styles/del.gif" OnClick="btnDel_Click" /></td>
        </tr>
        </table>
        </asp:Panel>
        </td>
