...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="help.ascx.cs" Inherits="SoftStore.admin.controls.help" %>
...
<table cellpadding="3" cellspacing="0" style="width: 100%">
            ...
            <asp:repeater id="rptList" runat="Server" >
                <itemtemplate>
                    <tr>
                        ...
                        <td><a href="default.aspx?n=help&id=<%# Eval("ID") %>" ><%# Eval("Title")%> </a></td>
    ...
    <tr>
        <td style="width: 100%">
        <asp:Panel ID="paEdit" runat="server" Width="100%">
