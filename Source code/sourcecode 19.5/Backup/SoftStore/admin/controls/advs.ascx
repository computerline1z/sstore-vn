<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="advs.ascx.cs" Inherits="SoftStore.admin.controls.advs" %>
            ...
            <asp:repeater id="rptList" runat="Server" >
                <itemtemplate>
                    <tr>
                        ...
                        <td><a href="default.aspx?n=advs&id=<%# Eval("ID") %>" ><%# Eval("AdvName")%> </a></td>
                        <td align="center"><%# Eval("Url")%> </td>
                        <td align="center"><%#DateTime.Parse(Eval("ExpireDate").ToString()).ToString("dd/MM/yyyy")%> </td>
    ...
    <tr>
        ...
        <asp:Panel ID="paEdit" runat="server" Width="100%" Visible="false">
            <table class="tableEdit" cellpadding="3" cellspacing="0" style="width: 100%">
                ...
                <tr>
                    <td class="bg_left" style="width: 15%">
                        Ngày hết hạn hiển thị</td>
                    <td colspan="3" style="width: 85%">
                    <cc2:Calendar ID="txtExpireDate" runat="server" Size="8" ToolTip="Select date" supportfolder="~/styles/JSCalendar" DateTimeFormat="dd/MM/yyyy" />
                    </td>
                </tr>
                <tr>
                    <td class="bg_left" style="width: 15%">
                ...
                <tr>
                    ...
                    <div id="div_img" style="display:<%=Display %>">
                            <img id="imgpic" runat="server" alt="" src="" width="180" style="border:1px solid #dadada" />
                        </div>
                    </td>
                </tr>
                <%--<tr>
                ...
                <tr>
                    <td colspan="4">
                        <FCKeditorV2:FCKeditor ID="txtContent" runat="server" BasePath="~/fckeditor/" Height="350px">
                ...
                <tr>
                    <td class="bg_left" style="width: 15%">
                        Width</td>
                    <td colspan="3" style="width: 85%">
                        <asp:TextBox ID="txtWidth" runat="server" CssClass="txt" Width="60px">180</asp:TextBox>
                        px</td>
                </tr>
                <tr>
                    <td class="bg_left" style="width: 15%">
