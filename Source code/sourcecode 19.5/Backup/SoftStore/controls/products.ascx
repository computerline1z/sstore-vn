...
<table cellpadding="0" cellspacing="0" style="float:right; margin:-5px -5px 0px 0px;">
                <tr>
                	<td colspan="3" style="text-transform:uppercase">
                    	<h4><asp:Literal ID="ltCategoryName" runat="server"></asp:Literal></h4>
                    </td>
                </tr>
                <tr>
                    <td id="frame-tl"/>
                    ...
                    <td>
                        <div id="content">
                            ...
                            <table id="tblList" width="100%">
                            	...
                            	<div class="item">
                                	<div class="img">
                                	<a class="title" href="/chi-tiet-sp/<%#Eval("ProductID") %>/<%#FriendlyURL.ConvertUrlFriendlyNoExt(Eval("ProductName")) %>.html">
                                    	<img src="/resources/products/<%#Eval("ProductID") %>/<%#Eval("Picture") %>" width="88px" /></a>
                                    </div>
                                    <a class="title" href="/chi-tiet-sp/<%#Eval("ProductID") %>/<%#FriendlyURL.ConvertUrlFriendlyNoExt(Eval("ProductName")) %>.html">
